...
namespace i5.OpenAI
{
	...
	public class TextRequest
	{
		...
		{
			using (UnityWebRequest request = UnityWebRequest.Post("https://api.openai.com/v1/responses",ToJson(),"application/json"))
			{
				request.SetRequestHeader("Authorization", "Bearer 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");
				...
				{
					fullAnswer = JsonUtility.FromJson<TextAnswer>(request.downloadHandler.text);
					answer = fullAnswer.output[0].content[0].text;
				}
			}
		}
...
namespace i5.VirtualAgents
{
    ...
    public class CurlTest : MonoBehaviour
    {
        ...
        void Start()
        {
			TextRequest request = new TextRequest("Hello!");
			StartCoroutine(request.Upload());
		}	
